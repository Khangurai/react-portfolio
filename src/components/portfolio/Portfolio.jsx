...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: 'Brand Design',
      category: 'design',
      image: '/src/assets/work2.jpg',
      description: 'Beautiful and elegant design, with modern and attractive interfaces.',
    ...
    },
    {
      ...
      description: 'App developed with React Native, with modern design and smooth animations.',
    ...
    },
    {
      ...
      title: 'UI/UX Design',
      category: 'design',
      image: '/src/assets/work5.jpg',
      description: 'Modern and intuitive user interface design for mobile and web applications.',
  ...
  return (
    <section className="portfolio section" id="portfolio">
      <Title level={2} className="section__title">Portfolio</Title>
        ...
        <div className="portfolio__filters">
          {categories.map(category => (
            <Button
              ...
              className={`portfolio__filter ${activeFilter === category.key ? 'active-work' : ''}`}
        ...
        <Row gutter={[24, 24]} className="portfolio__content">
          {filteredProjects.map(project => (
            <Col xs={24} md={12} lg={8} key={project.id}>
              <Card
                ...
                cover={
                  <div className="portfolio__img-container">
                    <img alt={project.title} src={project.image} className="portfolio__img" />
              ...
              >
                <Meta
                  title={<Title level={4} className="portfolio__title">{project.title}</Title>}
                  description={
                    <div>
